...
- **Dynamic Calibration:** Instantly locks onto your neutral "Lazy Gun" pose to provide lightning-fast, hyper-sensitive steering.
- **Brutalist Particle Physics:** A sleek, dark grid with smooth magnetic-pull transitions, collision explosions, and dynamic trailing sparks.
- **Frame-Perfect Collisions:** Real-time solid line-segment collision detection for unforgiving, twitch-reflex arcade gameplay.

## Installation

To run DEREZZED locally:
